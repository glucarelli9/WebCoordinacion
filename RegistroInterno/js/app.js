...
window.addEventListener("load", async () => {
  ...
  form.addEventListener("submit", (e) => {
    e.preventDefault();
    let opcionCorresponda3 =
      document.getElementById("opcionCorresponda3").value;
    let dnipasajero3 = document
      .getElementById("dnipasajero3")
      .value.toUpperCase();
    let nombrepasajero3 = document
      .getElementById("nombrepasajero3")
      .value.toUpperCase();

    let opcionCorresponda2 =
      document.getElementById("opcionCorresponda2").value;
    let dnipasajero2 = document
      .getElementById("dnipasajero2")
      .value.toUpperCase();
    let nombrepasajero2 = document
      .getElementById("nombrepasajero2")
      .value.toUpperCase();

    let opcionCorresponda = document.getElementById("opcionCorresponda").value;
    let dnipasajero = document
      .getElementById("dnipasajero")
      .value.toUpperCase();
    let nombrepasajero = document
      .getElementById("nombrepasajero")
      .value.toUpperCase();
